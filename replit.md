...
- **AI-Powered Anime Quiz**: Dynamic quiz questions generated by Gemini AI with multiple choice answers (A, B, C, D), 5-minute cooldown, and shard rewards
...
- `astramon quiz` - AI-powered anime trivia with multiple choice (5min cooldown, 150💎 reward)
...
## Recent Changes
- 2025-10-22: **AI-Powered Quiz Update**
  - Upgraded quiz command to use Gemini AI for dynamic question generation
  - Added multiple choice format (A, B, C, D) for better user experience
  - Increased reward to 150💎 for correct answers
  - Maintained 5-minute cooldown (now enforced regardless of answer correctness)
  - Added random anime emojis and enhanced owo-style messaging
  - Kept fallback to static questions if AI generation fails
  - Improved embed display with formatted options
